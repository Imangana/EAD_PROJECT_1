...
public class Checkout extends JFrame implements ActionListener {
    ...
    Checkout(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Saved Pictures/tick.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Saved Pictures/out chek.jpg"));
        Image i5 = i4.getImage().getScaledInstance(550,280,Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel image = new JLabel (i6);
        image.setBounds(350,50,400,250);
        add(image);
        
        setBounds(260,200,800,400);
        setVisible(true);
    }
